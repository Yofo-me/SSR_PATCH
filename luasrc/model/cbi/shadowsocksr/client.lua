...
o = s:option(Flag, "v2ray_flow", translate("开启V2ray分流"))
o.rmempty = false
o.description = translate("当使用v2ray分流功能时 主服务器必须为V2ray")

o = s:option(ListValue, "youtube_server", translate("Youtube 代理"))
...
o = s:option(ListValue, "tw_video_server", translate("台湾视频服务代理"))
o:value("nil", translate("Same as Global Server"))
for _,key in pairs(key_table_v2) do o:value(key,v2ray_table[key]) end
o:depends("v2ray_flow", "1")
o.default = "nil"
...
o = s:option(ListValue, "netflix_server", translate("Netflix 代理"))
o:value("nil", translate("Same as Global Server"))
for _,key in pairs(key_table_v2) do o:value(key,v2ray_table[key]) end
o:depends("v2ray_flow", "1")
o.default = "nil"
...
o = s:option(ListValue, "disney_server", translate("Diseny+ 代理"))
o:value("nil", translate("Same as Global Server"))
for _,key in pairs(key_table_v2) do o:value(key,v2ray_table[key]) end
o:depends("v2ray_flow", "1")
o.default = "nil"
...
o = s:option(ListValue, "prime_server", translate("Prime Video 代理"))
o:value("nil", translate("Same as Global Server"))
for _,key in pairs(key_table_v2) do o:value(key,v2ray_table[key]) end
o:depends("v2ray_flow", "1")
o.default = "nil"
